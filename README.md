...
# 📖 [Minimal Blog Card] <a name="about-project"></a>

> This is a solution to the Minimal Blog Card challenge on devChallenges.io. This challenge is a great way to start with basic HTML and CSS skills.

**[ Minimal Blog Card ]** The challenge is to create a simple blog card that includes an image, a title, a short description, and a tag.
...
- https://cuauh-cabrera.github.io/blog-card/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/blog-card.git
```
